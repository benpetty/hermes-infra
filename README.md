...
│   ├── signal-linking.md    # Post-deploy Signal QR step
...
7. Follow [`docs/signal-linking.md`](docs/signal-linking.md) for the one-time Signal QR scan.

Day-to-day, `make apply` is enough; the image is reused. Rebake only when:
- You want to bump Hermes Agent / signal-cli / Tailscale versions
